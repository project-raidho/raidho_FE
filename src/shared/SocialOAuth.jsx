...
export const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?client_id=${secrets.KAKAO_CLIENT_ID}&redirect_uri=${secrets.KAKAO_REDIRECT_URI}&response_type=code`;
