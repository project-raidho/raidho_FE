...
|  **react-kakao-login**  | - 인가코드만 받아서 넘기면 서버와 통신할 수 있다는 장점때문에 이 패키지를 선택                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| 2022.09.09 | - 모집방개설 페이지 날짜 형식 및 테마 변환 <br> - 모집방 리스트 페이지 작업 완료 <br> - 헤더 메뉴 추가 및 토글 이벤트 추가, 스크롤 이벤트 오류 수정 <br> 여행후기 등록 페이지 이미지 업로드 형식(blob) 변환 <br> - 타입스크립트 변환 도전으로 공부 |
